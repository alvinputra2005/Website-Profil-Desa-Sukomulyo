...
{
    private array $allowed = ['p'=>[],'br'=>[],'strong'=>[],'em'=>[],'u'=>[],'s'=>[],'h2'=>[],'h3'=>[],'h4'=>[],'blockquote'=>[],'ul'=>[],'ol'=>[],'li'=>[],'a'=>['href','title','target','rel'],'img'=>['src','alt','title'],'table'=>[],'thead'=>[],'tbody'=>[],'tr'=>[],'th'=>[],'td'=>[],'hr'=>[]];
    ...
    private function walk($node): void
    {
        foreach (iterator_to_array($node->childNodes) as $child) {
            ...
            if (! isset($this->allowed[$tag])) { $child->replaceWith(...iterator_to_array($child->childNodes)); continue; }
