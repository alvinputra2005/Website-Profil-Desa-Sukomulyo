...
class CrudController extends Controller
{
 ...
 public function edit(string $resource,int $id){$c=$this->resource($resource);$item=$c['model']::findOrFail($id);$this->ensureResourceAuthorized($c,'update',$item);if($resource==='news')$item->load(['featuredImage','category']);if($resource==='publications'&&$item->type==='announcement')$c['title']='Pengumuman Desa';return view($resource==='news'?'admin.news.form':'admin.crud.form',$this->formData($resource,$c,$item));}
