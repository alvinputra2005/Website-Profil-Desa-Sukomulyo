...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('letter_application_status_histories')) {
            Schema::create('letter_application_status_histories', function (Blueprint $table) {
                $table->id();
                $table->foreignId('letter_application_id');
                $table->foreign('letter_application_id', 'letter_history_application_fk')->references('id')->on('letter_applications')->cascadeOnDelete();
