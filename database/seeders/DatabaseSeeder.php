...
use App\Models\{Gallery,IdmScore,News,NewsCategory,Official,Role,Setting,StatisticDataset,User,VillageProfileSection};
...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $category=NewsCategory::firstOrCreate(['slug'=>'pemerintahan'],['name'=>'Pemerintahan','description'=>'Kabar pemerintahan desa']);
        News::firstOrCreate(['slug'=>'musyawarah-desa-penyusunan-program-kerja'],['category_id'=>$category->id,'title'=>'Musyawarah Desa Penyusunan Program Kerja','excerpt'=>'Pemerintah desa bersama warga membahas prioritas pembangunan.','content'=>'<p>Musyawarah desa menjadi ruang bersama untuk menentukan arah pembangunan Desa Sukomulyo.</p>','status'=>'published','published_at'=>now(),'author_id'=>$admin->id]);
