...
function social_care_lite_setup() {		
	$GLOBALS['content_width'] = apply_filters( 'social_care_lite_content_width', 680 );	
...
define('SOCIAL_CARE_LITE_THEME_DOC',__('http://www.gracethemesdemo.com/documentation/social-care/#homepage-lite','social-care-lite'));
define('SOCIAL_CARE_LITE_PROTHEME_URL',__('https://gracethemes.com/themes/charitable-organizations-wordpress-theme/','social-care-lite'));
define('SOCIAL_CARE_LITE_LIVE_DEMO',__('http://www.gracethemesdemo.com/social-care/','social-care-lite'));
 ...
 */
add_action( 'after_setup_theme', 'social_care_lite_setup_woocommerce_support' );
function social_care_lite_setup_woocommerce_support()   
{
