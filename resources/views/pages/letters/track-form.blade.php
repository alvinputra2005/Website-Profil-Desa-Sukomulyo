<x-layouts.app title="Lacak Permohonan Surat" robots="noindex, nofollow">
    <x-page-header title="Lacak Permohonan Surat" description="Pantau tahapan resmi permohonan surat Anda melalui website desa." :show-heading="true" :breadcrumbs="[['label'=>'Pelayanan'],['label'=>'Pengajuan Surat','url'=>route('letter-services.index')],['label'=>'Lacak Permohonan']]" />
