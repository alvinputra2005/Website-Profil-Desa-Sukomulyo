<x-layouts.app title="Perbaiki Permohonan" robots="noindex, nofollow">
    <x-page-header title="Perbaiki Permohonan" :description="$application->application_number" :show-heading="true" :breadcrumbs="[['label'=>'Pelayanan'],['label'=>'Pengajuan Surat','url'=>route('letter-services.index')],['label'=>'Perbaiki Permohonan']]" />
