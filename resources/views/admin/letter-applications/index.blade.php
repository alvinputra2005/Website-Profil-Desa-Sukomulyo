...
@section('content')
<div class="box box-primary"><div class="box-header with-border"><h3 class="box-title">Daftar Permohonan</h3><div class="box-tools admin-list-actions"><form id="bulk-delete-letter-applications" method="post" action="{{ route('admin.letter-applications.bulk-destroy') }}" class="inline-form" data-confirm="Hapus permohonan surat yang dipilih? Dokumen unggahan terkait juga akan dihapus." data-confirm-tone="danger" data-confirm-title="Hapus Permohonan Terpilih" data-confirm-button="Ya, hapus">@csrf @method('delete')<button class="btn btn-danger btn-sm" type="submit" data-bulk-button disabled><i class="fa fa-trash" aria-hidden="true"></i> Hapus Terpilih</button></form></div></div><div class="box-body">
