...
<div class="box box-info">
    <div class="box-header with-border"><h3 class="box-title"><i class="fa fa-sitemap"></i> Daftar Kelompok</h3><div class="box-tools"><a href="{{ route('admin.population.groups.create') }}" class="btn btn-social btn-info btn-sm"><i class="fa fa-plus"></i> Tambah Kelompok</a></div></div>
    <div class="box-body">
        ...
        <div class="table-responsive"><table class="table table-striped table-hover population-table">
            <thead><tr><th>No</th><th>Aksi</th><th>Kode</th><th>Nama Kelompok</th><th>Ketua</th><th>Kategori</th><th>Anggota</th><th>Status</th></tr></thead>
            ...
            </tr>@empty<tr><td colspan="8" class="empty-state"><i class="fa fa-sitemap"></i><br>Belum ada kelompok.</td></tr>@endforelse</tbody>
        </table></div>
        {{ $groups->links() }}
    </div>
</div>
