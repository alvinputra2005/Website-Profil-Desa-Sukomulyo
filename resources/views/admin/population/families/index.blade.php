...
<div class="box box-info">
    <div class="box-header with-border"><h3 class="box-title"><i class="fa fa-id-card"></i> Daftar Keluarga</h3><div class="box-tools"><a href="{{ route('admin.population.families.create') }}" class="btn btn-social btn-info btn-sm"><i class="fa fa-plus"></i> Tambah Keluarga</a></div></div>
    <div class="box-body">
        ...
        <div class="table-responsive"><table class="table table-striped table-hover population-table">
            <thead><tr><th>No</th><th>Aksi</th><th>Nomor KK</th><th>Kepala Keluarga</th><th>NIK</th><th>Anggota</th><th>Alamat/Wilayah</th><th>Terdaftar</th><th>Status</th></tr></thead>
            ...
            </tr>@empty<tr><td colspan="9" class="empty-state"><i class="fa fa-id-card"></i><br>Belum ada data keluarga.</td></tr>@endforelse</tbody>
        </table></div>
        {{ $families->links() }}
    </div>
</div>
