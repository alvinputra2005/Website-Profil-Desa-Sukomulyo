...
<div class="box box-info news-list-box">
    <div class="box-header with-border news-list-header">
        ...
        <form id="bulk-delete-galleries" method="post" action="{{ route('admin.resources.bulk-destroy', 'galleries') }}" class="inline-form" data-confirm="Hapus galeri yang dipilih? Galeri akan dipindahkan ke tempat sampah." data-confirm-tone="danger" data-confirm-title="Hapus Galeri Terpilih" data-confirm-button="Ya, hapus">
            @csrf @method('delete')
    ...
    <div class="box-body">
        ...
        </tr>@empty<tr><td colspan="8" class="empty-state"><i class="fa fa-picture-o fa-3x"></i><h4>Belum ada galeri</h4><p>Tambahkan dokumentasi kegiatan pertama.</p></td></tr>@endforelse
        </tbody></table></div>
