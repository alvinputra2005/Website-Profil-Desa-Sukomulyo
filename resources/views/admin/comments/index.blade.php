...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <form id="bulk-delete-comments" method="post" action="{{ route('admin.comments.bulk-destroy') }}" class="inline-form" data-confirm="Hapus komentar yang dipilih?" data-confirm-tone="danger" data-confirm-title="Hapus Komentar Terpilih" data-confirm-button="Ya, hapus">
            @csrf
            @method('delete')
            <button class="btn btn-danger btn-sm" type="submit" data-bulk-button disabled style="margin-right:12px"><i class="fa fa-trash"></i> Hapus Terpilih</button>
            <div class="box-tools">
                <form class="form-inline">
                    ...
                    <select name="status" class="form-control input-sm" style="width:140px;margin-left:8px">
