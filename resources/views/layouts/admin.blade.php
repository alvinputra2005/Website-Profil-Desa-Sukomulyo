    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                ['label'=>'Info Desa','icon'=>'fa-home','ability'=>'manage-content','items'=>[['Profil Desa','admin.village-content.edit','profile'],['Visi Misi','admin.village-content.edit','vision-mission'],['Sejarah Desa','admin.village-content.edit','history'],['Potensi Desa','admin.village-content.edit','potential']]],
                ['label'=>'Administrasi Umum','icon'=>'fa-archive','ability'=>'manage-content','items'=>[['Buku Pemerintah Desa','admin.officials.index',null]]],
