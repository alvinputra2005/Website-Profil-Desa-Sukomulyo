    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                ['label'=>'Informasi Publik','icon'=>'fa-file-text','ability'=>'manage-content','items'=>[['Pengumuman Desa','admin.resources.index','publications',['type'=>'announcement']],['Dokumen Publik','admin.resources.index','publications'],['Lampiran Publikasi','admin.resources.index','publication-attachments'],['Data APBDes','admin.apbdes.index',null]]],
