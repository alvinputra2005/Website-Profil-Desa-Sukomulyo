    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                ['label'=>'Info Desa','icon'=>'fa-home','ability'=>'manage-content','items'=>[['Profil Desa','admin.village-content.edit','profile'],['Visi Misi','admin.village-content.edit','vision-mission'],['Sejarah Desa','admin.village-content.edit','history'],['Struktur Pemerintahan','admin.resources.index','officials'],['Potensi Desa','admin.village-content.edit','potential']]],
                ['label'=>'Kependudukan','icon'=>'fa-users','ability'=>'manage-data','items'=>[['Penduduk','admin.population.residents.index',null],['Keluarga','admin.population.families.index',null],['Rumah Tangga','admin.population.households.index',null],['Kelompok','admin.population.groups.index',null],['Statistik Kependudukan','admin.population.statistics',null],['Laporan Penduduk','admin.population.report',null]]],
                ['label'=>'Admin Web','icon'=>'fa-desktop','ability'=>'manage-content','items'=>[['Artikel','admin.resources.index','news'],['Kategori Artikel','admin.resources.index','categories'],['Galeri','admin.resources.index','galleries'],['Item Galeri','admin.resources.index','gallery-items'],['Media Sosial/Library','admin.media.index',null]]],
