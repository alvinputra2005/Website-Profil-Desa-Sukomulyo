    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                ['label'=>'Kependudukan','icon'=>'fa-users','ability'=>'manage-data','items'=>[['Penduduk','admin.population.residents.index',null],['Keluarga','admin.population.families.index',null],['Rumah Tangga','admin.population.households.index',null],['Statistik Kependudukan','admin.population.statistics',null],['Statistik Tahunan','admin.population.yearly-snapshots.index',null],['Laporan Penduduk','admin.population.report',null]]],
